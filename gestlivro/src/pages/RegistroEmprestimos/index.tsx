...
export default function RegisterLoanPageForm({ handleChange, handleCheckboxChange, handleSubmit, handleClearDataModal, handleCloseModal, formData }: RegisterLoanPageFormData) {
